...
public class ConsultarVeiculo extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTable_Veiculo = new javax.swing.JTable();
        ...
        jTable_Veiculo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Veiculo);
    ...
    public void LimparTab(){
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Veiculo.getModel();
    ...
    public void BuscarTab(String sql){
        ...
        DefaultTableModel ModeloTab = (DefaultTableModel) jTable_Veiculo.getModel();
           ...
           // Conectar ao banco de dados e obter dados da tabela
            String SQL = JOptionPane.showInputDialog("Digite Placa:");
            try {
                //JOptionPane.showMessageDialog(null,sql);
                PreparedStatement ps = conn.getConexao().prepareStatement(sql);
                ps.setString(1, SQL);
    ...
    public void Atualizar(){
        int i = jTable_Veiculo.getSelectedRow();
        // Obtendo o dados da primeira linha selecionada
        VeiculoM v = new VeiculoM();
        v.setIdveiculo(jTable_Veiculo.getModel().getValueAt(i,0).toString());
        v.setFabricante(jTable_Veiculo.getModel().getValueAt(i,1).toString());
        v.setModelo(jTable_Veiculo.getModel().getValueAt(i,2).toString());
        v.setAnoFabricacao(jTable_Veiculo.getModel().getValueAt(i,3).toString());
        v.setPlaca(jTable_Veiculo.getModel().getValueAt(i,4).toString());
        v.setCategoria(jTable_Veiculo.getModel().getValueAt(i,5).toString());
        v.setMotorista(jTable_Veiculo.getModel().getValueAt(i,6).toString());
    ...
    public void Excluir(){
        ...
        int o = (int) jTable_Veiculo.getValueAt(i, 0);
        Vdao.excluir(o);
    ...
    private javax.swing.JTable jTable_Veiculo;
