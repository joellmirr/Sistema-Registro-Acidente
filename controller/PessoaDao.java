...
public abstract class PessoaDao implements Dao{
    ...
    public void inserir(Object o) {
       ...
       String sql = "INSERT INTO Pessoa (nome,cnh,cpf,email,telefone,endereco) VALUES(?,?,?,?,?,?)";
       try{
    ...
    public void atualizar(Object o) {
        PessoaFisica p = (PessoaFisica) o;
         String sql = "UPDATE Pessoa SET nome=?,cnh=?,cpf=?,email=?,telefone=?,endereco=? WHERE idpessoa=?";
         try{
           PreparedStatement ps = conn.getConexao().prepareStatement(sql);
           ps.setString(1,p.getNome());
           ps.setString(2,p.getCpf());
